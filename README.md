...
This is a custom board reimagination of the Aladdin chip for the Original Xbox code written by Ryzee119 Ideally. gerbers are available [here](Gerbers/jafar_gerber_v1.zip).
